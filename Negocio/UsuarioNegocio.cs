...
namespace Negocio
{
    public class UsuarioNegocio
    {
        ...
        public static bool ValidateUsuario(string usuario, string nombre, string apellido)
        {
            return usuario.Length >= 8 && usuario.Length <= 15 && !usuario.Contains(nombre) && !usuario.Contains(apellido);
        }
