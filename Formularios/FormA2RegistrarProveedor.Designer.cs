namespace Form1
{
    partial class FormA2RegistrarProveedor
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnCancelarRegistrarProveedor = new Button();
            lblRegistrarProveedor = new Label();
            SuspendLayout();
            // 
            ...
            // 
            // btnCancelarRegistrarProveedor
            // 
            btnCancelarRegistrarProveedor.Location = new Point(188, 699);
            btnCancelarRegistrarProveedor.Margin = new Padding(6, 7, 6, 7);
            btnCancelarRegistrarProveedor.Name = "btnCancelarRegistrarProveedor";
            btnCancelarRegistrarProveedor.Size = new Size(400, 69);
            btnCancelarRegistrarProveedor.TabIndex = 32;
            btnCancelarRegistrarProveedor.Text = "Volver Atras";
            btnCancelarRegistrarProveedor.UseVisualStyleBackColor = true;
            btnCancelarRegistrarProveedor.Click += btnCancelarRegistrarProveedor_Click;
            // 
            // lblRegistrarProveedor
            // 
            lblRegistrarProveedor.AutoSize = true;
            lblRegistrarProveedor.Location = new Point(234, 25);
            lblRegistrarProveedor.Margin = new Padding(6, 0, 6, 0);
            lblRegistrarProveedor.Name = "lblRegistrarProveedor";
            lblRegistrarProveedor.Size = new Size(684, 32);
            lblRegistrarProveedor.TabIndex = 33;
            lblRegistrarProveedor.Text = "Desde este formulario, puede registrar al proveedor que desee";
            // 
            ...
            Controls.Add(lblRegistrarProveedor);
            Controls.Add(btnCancelarRegistrarProveedor);
            ...
            Load += FormA2RegistrarProveedor_Load;
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private Button btnCancelarRegistrarProveedor;
        private Label lblRegistrarProveedor;
    }
}